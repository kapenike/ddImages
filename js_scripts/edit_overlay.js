...
function tempHandleToggleCondition(toggle, is_init = false) {
					...
					children: [
						Create('input', {
							...
							onclick: function () {
								...
								tempHandleToggleCondition('$comp$equal$/comp$');
							}
						})
					]
				})
				...
				children: [
					...
					Create('span', {
						...
						children: [
							Create('div', {
								id: 'toggle_condition',
								children: [tempHandleToggleCondition(layer.toggle, true)]
							})
						]
					})
				]
